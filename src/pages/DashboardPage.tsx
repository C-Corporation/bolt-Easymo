...
const DashboardPage: React.FC = () => {
  ...
  const stats = [
    { title: 'Biens immobiliers', value: '24', icon: <Home className="h-6 w-6 text-[#E84A33]" />, link: '/immobiliers' },
    { title: 'Locataires', value: '18', icon: <Users className="h-6 w-6 text-[#E84A33]" />, link: '/locataires' },
    { title: 'Loyers mensuels', value: '12 450 €', icon: <DollarSign className="h-6 w-6 text-[#E84A33]" /> },
    { title: 'Taux d\'occupation', value: '85%', icon: <BarChart2 className="h-6 w-6 text-[#E84A33]" /> },
  ];

  // Dernières activités
  const recentActivities = [
    { id: 1, title: 'Nouveau contrat signé', description: 'M. Dupont - Appartement B12', date: '20/05/2025', type: 'contrat' },
    { id: 2, title: 'Paiement reçu', description: 'Mme Martin - 750€ - Mai 2025', date: '19/05/2025', type: 'paiement' },
    { id: 3, title: 'Visite programmée', description: 'Appartement A5 - Demain 14h', date: '18/05/2025', type: 'visite' },
  ];

  // Prochains échéanciers
  const upcomingPayments = [
    { id: 1, tenant: 'M. Durand', amount: '750 €', dueDate: '05/06/2025', status: 'À venir' },
    { id: 2, tenant: 'Mme Leroy', amount: '620 €', dueDate: '05/06/2025', status: 'À venir' },
    { id: 3, tenant: 'M. et Mme Bernard', amount: '850 €', dueDate: '10/06/2025', status: 'À venir' },
  ];

  return (
    <div className="flex flex-col min-h-0 h-full">
      {/* En-tête fixe */}
      <div className="bg-[#2A2F36] p-6">
